import {ADD_FEATURE, REMOVE_FEATURE} from '../components/action/action'
...
export const reducer =(state = initialState , action) => {
    ...
    case (REMOVE_FEATURE):
        const removeFeature = state.car.features.find((feature) => feature.id === feature.id)
        return({...state, additionalFeatures:[...state.additionalFeatures, removeFeature], 
