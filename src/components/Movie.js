...
const Movie = (props) => {
  ...
  const handleAddFav = (id) => {
    props.addFav(id); ///could also pass in movie here and get rid of the anonymous function in the onClick below
  };
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="flexContainer">
              ...
              <section>
                <span className="m-2 btn btn-dark" onClick={() => handleAddFav(movie)}>
                  Favorite
                </span>
...
const mapStateToProps = (state) => {
  console.log("mapStateToProps--movie.js: ", state);
  return {
