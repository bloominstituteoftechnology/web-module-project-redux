...
import { toggleDisplayFavorites } from '../actions/favoriteActions';
...
const MovieHeader = (props) => {
    ...
    return(
        ...
        <div className="col-sm-6 headerBar">
            <div className="btn btn-sm btn-primary"><span onClick={props.toggleDisplayFavorites}>{ props.displayFavorites ? "Hide" : "Show"} Favorites</span>
        </div>
