...
> _Within the reducers folder is the movieReducers file. We have the state already setup in here with some initial data. Let's connect that state to our component._
